...
| `gate-evasion-v1` | Each fixture is a way a change once evaded a quality gate; the named gate runs on it through `GateRunner` | — | 8 classes | today 2/8, see `docs/eval/bench.md` |
